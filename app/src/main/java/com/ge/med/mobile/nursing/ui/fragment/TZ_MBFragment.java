 ...
 */
public class TZ_MBFragment extends BaseFragment implements View.OnClickListener {
    ...
    public int setRootView() {
        return R.layout.fragment_tz__mb;
    }
