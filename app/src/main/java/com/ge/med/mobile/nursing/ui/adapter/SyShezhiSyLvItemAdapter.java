...
public class SyShezhiSyLvItemAdapter extends BaseAdapter {
    ...
    public SyShezhiSyLvItemAdapter(Context context,List<RWentity> rWentities) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = layoutInflater.inflate(R.layout.sy_shezhi_sy_lv_item, null);
