...
public class YZ_ZX_ZhuShe_FenCiActivity extends MyBaseActivity implements View.OnClickListener {
    ...
    public int setRootView() {
        return R.layout.activity_yz__zx__zhu_she__fen_ci;
    }
    @Override
    ...
    public void initViews() {
        ...
        mHzSjBgTv = (TextView) findViewById(R.id.hz_sj_bg_tv);
...
//                jianPanChuLi(mBt24);
            ...
            case R.id.yz_zx_zhushe_fenci_baocun_bt:
                ...
                if(null==s||"".equals(s)||"0".equals(s)){
                 showToastShort("请输入次数！");
                    break;
                }
                mBundle.putInt(Constant.BUNDLE_KEY_FENCI,Integer.parseInt(s));
                goToActivity(YZ_ZX_ZhuShe_FenCi_SJActivity.class,mBundle);
                break;
        }
    }

    private void jianPanChuLi(Button mBt11) {
            if(mTiZhengZhi.getText().toString().length()>1){
                return;
        }
        stringBuilder = new StringBuilder(mTiZhengZhi.getText());
