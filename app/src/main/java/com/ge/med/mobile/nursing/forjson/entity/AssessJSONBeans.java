 ...
 */
public class AssessJSONBeans implements BaseJSONBean {
    /**
     * status : 1
    ...
    private List<AssessRecordBean> data;
    private String msg;
    ...
    @Override
    public List<AssessRecordBean> getData() {
        return data;
    }

    public void setData(List<AssessRecordBean> data) {
        this.data = data;
    }
